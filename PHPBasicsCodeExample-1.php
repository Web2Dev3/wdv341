...
<h2>PHP Basics - Code Example-1</h2>
...
<p>Result: Use PHP to display your name <?php echo "Savanna" ?> in this paragraph.</p>
...
?>
<p>Result: Create a string variable called yourName. Assign it the value of your name and display it <?php echo $yourName = "Savanna Kohler"; ?></p>
