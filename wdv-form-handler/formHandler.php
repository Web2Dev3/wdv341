...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inOpt1 = $_POST["optradio1"];
	$inOpt2 = $_POST["optradio2"];
	$inOpt3 = $_POST["optradio3"];
	$inChk = $_POST["checkbox"];
	$inChk2 = $_POST["checkbox2"];
	$inSelect = $_POST["courses"];
	$inHidden = $_POST["test_name"];
...
<p>Option 1: <?php echo $inOpt1; ?></p>
<p>Option 2: <?php echo $inOpt2; ?></p>
<p>Option 3: <?php echo $inOpt3; ?></p>
<p>Checkbox 1: <?php echo $inChk; ?></p>
<p>Checkbox 2: <?php echo $inChk2; ?></p>
<p>Course: <?php echo $inSelect; ?></p>
<p>Test Honeypot: <?php echo $inHidden; ?></p>
